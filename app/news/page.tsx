...
import { TFilter } from '@apptypes/api';
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description =
    'Актуальные новости, информация о новинках, график работы и вакансии компании ' +
    (globalMeta?.data.attributes.title ?? '');
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <path
                            d="M1 5.25C0.585786 5.25 0.25 5.58579 0.25 6C0.25 6.41421 0.585787 6.75 1 6.75L1 5.25ZM35.5303 6.53033C35.8232 6.23743 35.8232 5.76256 35.5303 5.46967L30.7574 0.696697C30.4645 0.403803 29.9896 0.403803 29.6967 0.696697C29.4038 0.98959 29.4038 1.46446 29.6967 1.75736L33.9393 6L29.6967 10.2426C29.4038 10.5355 29.4038 11.0104 29.6967 11.3033C29.9896 11.5962 30.4645 11.5962 30.7574 11.3033L35.5303 6.53033ZM1 6.75L35 6.75L35 5.25L1 5.25L1 6.75Z"
                            fill="#F49AA5"
                          />
                        </svg>
                      </Link>
                      <div className="type_name" role="tag">
                        {newsType}
                      </div>
                    </div>
                  </article>
