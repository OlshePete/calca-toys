...
export default async function Home() {
  ...
  return (
    <>
      <div className="section fullH" style={{ position: 'relative', top: '-77px' }}>
        <MainCarouselContent />
      </div>
      ...
      <div className="section" style={{ background: "#FEF7E6", padding: '110px 0' }}>
        <ProductsCarousel label="игрушки" products={products.data.filter(p => p?.attributes.type.data.attributes.internal === "toy")} link='/toy' />
      </div>
      <div className="section" style={{ background: "#FEF7E6", padding: '110px 0' }}>
