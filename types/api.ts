...
export interface IImageUrl
  extends IResponseItemWithDataMeta<
    IResponseData<{
      url: string;
    }>
  > {}
...
export interface IMainCarouselContent
  extends IMainCorouselData<Array<IResponseData<ICarouselItem>>> {}
...
export interface IProductsTypesContent
  extends IResponseArrayWithDataMeta<IResponseData<IProductType>> {}
...
export interface ISearchedServicesContent
  extends IResponseItemInArrayWithDataMeta<IResponseData<IService>> {}
