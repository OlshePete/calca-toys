...
import { IContacts } from '@apptypes/api';
import Image from 'next/image';
import CustomContactBox from './CustomContactBox';
import { Box } from '@chakra-ui/react';
import { FooterNavNextElement } from '@apptypes';
...
async function FooterNav() {
  ...
  return (
    <Box as="nav" gap={2} display={'flex'} py={6} bg="transparent">
      {data &&
        data.map((block, index, arr) => {
