  ...
  return (
    <div className="footer-summary" style={{ background: 'transparent' }}>
      ...
      <FooterCustomStack direction="column" gap={16}>
        <CustomText fontSize={14} maxWidth={{ base: '120px', lg: '100%' }} lineHeight={'20px'}>
          Мы&nbsp;принимаем к&nbsp;оплате:
        </CustomText>
        <FooterCustomStack direction={{ base: 'column', lg: 'row' }} gap={16} alignItems={'center'}>
          <Image src="/masterCard.svg" alt="masterCard Logo" width={41} height={24} />
          <Image src="/visa.svg" alt="visa Logo" width={43} height={24} />
          <Image src="/mir.svg" alt="mir Logo" width={43} height={24} />
        </FooterCustomStack>
      </FooterCustomStack>
      <CustomText
        style={{
